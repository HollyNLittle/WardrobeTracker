...
namespace WardrobeTracker.Controllers
{
    public class DescriptionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DescriptionID,Name,Photo")] Description description)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DescriptionID,Name,Photo")] Description description)
        {
            if (ModelState.IsValid)
            {
